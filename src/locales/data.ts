...
const data = {
  en: {
    ...
    views_warehouse: {
      ...
      offline: "Replay analytics are currently unreachable. Data will appear once the service is back online.",
      replayCount: "{n} replays",
      race: "Race",
      opponent: "Opponent",
      map: "Map",
      player: "Player",
    ...
    components_warehouse_table: {
      map: "Map",
      played: "Played",
      downloadReplay: "Download .w3g",
      noReplays: "No replays found.",
    },
    components_warehouse_search: {
      scopeNote: "Finds individual games — every result is a ladder match you can open.",
      matchAllPlayers: "Match all players",
      eventBuilding: "Building",
      eventUnit: "Unit",
      eventUpgrade: "Upgrade",
      eventItem: "Item",
      eventHeroSkill: "Hero skill",
      eventHeroTrained: "Hero trained",
      heroOrdinal: "Hero #",
      heroOrdinalAny: "Any",
      heroOrdinalFirst: "1st hero",
      heroOrdinalSecond: "2nd hero",
      heroOrdinalThird: "3rd hero",
      group: "Group",
      groupYours: "Your build",
      groupOpponent: "Opponent",
      groupOpponentRaceHint: "Pin the opponent's race",
      remove: "Remove",
      resultAny: "Any",
      resultWon: "Won",
      resultLost: "Lost",
      event: "Event",
      subject: "Subject",
      withinPrev: "Within prev (s)",
      fromSec: "From (s)",
      toSec: "To (s)",
      addStep: "Add step",
      addGroup: "Add group",
      search: "Search",
      matchingReplays: "{n} matching replays",
    },
    components_warehouse_openers: {
      scopeNote: "Aggregated across all ladder matches for the chosen matchup — not a single game. Click a row to unfold what players build next.",
      sortBy: "Sort by",
      rolled: "Rolled",
      rolledAny: "Any outcome",
      popular: "Popular",
      highWinrate: "High winrate",
      winrateNote: "winrate tint: red <44% · ~50% · green >56% (needs ≥10 matches)",
      opening: "Opening",
      totalMatches: "{n} matches for this filter",
      opener: "Opener",
      matches: "Matches",
      winrate: "Winrate",
      avgDuration: "Avg duration",
      next: "Next",
      showReplays: "Show replays",
      noOpeners: "No openers for this filter.",
      replaysFor: "Replays for",
    },
    components_warehouse_stats: {
      matchupWinrates: "Matchup winrates",
      heroPickrates: "Hero pickrates",
      ...
      count: "Count",
      games: "games",
      scopeNote: "Aggregated across every ladder match in scope — not a single game.",
      gamesInScope: "{n} games in scope",
      emptyScope: "No games match this filter. Widen the matchup, drop the map, or relax the season/MMR range.",
    },
    components_warehouse_statevents: {
      scopeNote: "Inspects ONE game at a time. These come from instrumented maps and are not ladder matches, so they don't link to match history.",
      phaseLabel: "Outcomes",
      kindLabel: "Kind",
      empty: "No instrumented replays loaded yet. These come from games played on stat-events-enabled maps, which record confirmed outcomes (cancels, exact resources) that normal replays can't.",
      players: "Players",
      duration: "Duration",
      events: "Events",
      cancels: "Cancels",
      qaOk: "complete stream",
      qaGaps: "gaps in stream",
      buildOrders: "Build orders",
      phaseBuild: "Build order",
      phaseCancels: "Cancels",
      phaseAll: "All outcomes",
      kindAll: "All",
      kindStructures: "Structures",
      kindUnits: "Units",
      kindUpgrades: "Upgrades",
      cancelled: "cancelled",
      cancelledAt: "cancelled at {clock}",
      cancelledOfStart: "cancels the {clock} start",
      heroesKilled: "Heroes killed",
      unitsKilled: "Units killed",
      unitsLost: "Units lost",
      unitsProduced: "Units produced",
      buildingsBuilt: "Buildings built",
      creepsKilled: "Creeps killed",
      ...
      layerStarts: "Starts",
      catTech: "Buildings",
      catHeroes: "Heroes & levels",
      catSkills: "Hero skills",
      catResearch: "Research & upgrades",
      catItems: "Items",
      catItemSwaps: "Item juggling",
      itemBought: "bought {item}",
      itemSold: "sold {item}",
      itemFound: "found {item}",
      itemDropped: "dropped {item}",
      itemPickedUp: "picked up {item}",
      catCancels: "Cancels",
      catHeroKills: "Hero kills",
      catDenies: "Denies",
      denied: "denied {unit} ({xp} XP, {total} total)",
      mapActivity: "Map activity",
      mapLayer: "Layer",
      layerCreeps: "Creep kills",
      layerDeaths: "Deaths",
      layerFights: "Fights",
      economy: "Economy",
      gold: "Gold",
      ...
      combat: "Combat",
      kd: "Kills / deaths",
      xpDenied: "{count} denies, {xp} XP denied",
      killsByUnit: "Kills by unit",
      topDamage: "Top damage pairs",
      heroes: "Heroes",
      losses: "Losses",
      time: "Time",
      owner: "Owner",
      unit: "Unit",
      killedBy: "Killed by",
      betaNote: "Beta — data from instrumented maps only. Creep routes, spell casts and summons are in the data but not rendered here yet.",
    },
    views_admin: {
